...
export default function CreateRecipie({ recpie, edit } : { edit: boolean, recpie: { title: string, description: string }  }) {
  const [ingredients, setIngredients] = useState(recpie?.ingredients || [{ name: "", amount: "", unit: "" }])
  const [steps, setSteps] = useState(recpie?.steps ||  [{ description: "", time: "" }])
  ...
  const handleSubmit = (e) => {
    ...
    setIngredients(ingredients.filter((a: any) => a.name !== ""));
    setSteps(steps.filter((a) => a.description !== ""));
    ...
    setData('image', "this is the data")
          ...
          <TabsContent value="details" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Upload a high-quality image of your finished dish</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-col items-center justify-center gap-4">
                  ...
                  <div className="flex justify-center">
                    <Label htmlFor="recipe-image" className="cursor-pointer">
                      <div className="flex items-center gap-2 text-sm text-orange-500 hover:text-orange-600">
                        <Upload className="h-4 w-4" />
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Slider id="difficulty-slider" defaultValue={[50]} max={100} step={1} className="py-4" />
